...
@Component({
  selector: 'app-dark-souls-lore',
  templateUrl: './dark-souls-lore.component.html',
  styleUrls: ['./dark-souls-lore.component.scss']
})
export class DarkSoulsLoreComponent implements OnInit {
  ...
  constructor(private breadcrumbService: AppBreadcrumbService) {
      this.breadcrumbService.setItems([
          { label: 'Dark Souls' },
          { label: 'Lore', routerLink: ['/utilities/widgets'] }
      ]);
  }
